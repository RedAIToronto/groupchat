        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <motion.div className="lg:w-1/2" variants={itemVariants}>
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6 mt-8">
              <motion.a
                href="https://t.me/pwigportal"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gradient-to-r from-pink-500 to-purple-600 text-white font-bold py-3 px-8 rounded-full hover:from-pink-600 hover:to-purple-700 transition-all duration-300 shadow-lg text-lg flex items-center justify-center"
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/10 text-white font-bold py-3 px-8 rounded-full border-2 border-white/30 hover:bg-white/20 transition-all duration-300 shadow-lg text-lg flex items-center justify-center"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <svg 
